    ...
    <Box pb="2rem" mt={4} >
      ...
      <Box bg='#003580' w='100%' color='white'>
        ...
        <Box w='100%' m="auto" p={2} borderTop="1px solid" >
          <Grid templateColumns={{ base: "repeat(1, 1fr)", sm: "repeat(2, 1fr)", md: "repeat(3, 1fr)", lg: "repeat(5, 1fr)" }} cursor="pointer" fontWeight="600" w="90%" fontSize="14px" ml="4rem" >
            <Text style={{ marginTop: '8px' }}>Mobile version</Text>
            <Text>Manage your bookings</Text>
            <Text>Customer service help</Text>
            <Text>Become an affiliate</Text>
            <Text>SilShine.com for Business</Text>
          </Grid>
        </Box>
      </Box>
